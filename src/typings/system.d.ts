...
declare namespace Service {
  ...
  /** 自定义的请求结果 */
  type RestfulResult<T = any> = import('@/share/http').RestfulResult<T>;

  /** mock示例接口类型：后端接口返回的数据的类型 */
  type MockServiceResult<T = any> = import('@/share/http').RestfulResult<T>;

  type PaginationResult<T = any> = RestfulResult<Common.Pagination<T>>;
  /** mock的响应option */
