<template>
  <div class="relative flex-center side-full" :style="{ backgroundColor: bgColor }">
    <dark-mode-switch
      :dark="theme.darkMode"
...
import { Github, LoginBg, PwdLogin, Register, ResetPwd } from './components';
...
const modules: LoginModule[] = [
  ...
  { key: 'github-login', label: loginModuleLabels['github-login'], component: Github }
];
